$(document).ready(function(){ //make sure the page loads before you request info
    ...
    $('#3').click(function(){
        ...
        $.get('http://jsonplaceholder.typicode.com/comments/', function(comments) {
            comments.forEach(function(comment){
                ...
                li.html("Comment "+comment.id+": "+br+comment.name+br+comment.email+br+comment.body);
                list.append(li);
                }//if
            }//foreach function
        )})//get function
    ...
    $('#5').click(function(){
        ...
        $.post('http://jsonplaceholder.typicode.com/posts/',  
            ...
            body: 'This is the body of said post.'}, function(post){
                const li = $('<li>');
                const br = ('<br>');
    ...
    $('#6').click(function(){
        ...
        $.ajax({
            ...
            method: 'PUT',  
            dataType: 'json',
            data: {title: 'new title', id: 101},//referring to the post we just created which has an ID of 101
